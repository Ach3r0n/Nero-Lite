...
start /B /WAIT "PreProcessing - NeroLite_english_lite.iss" /low "%InnoSetupPath%\iscc.exe" NeroLite_main.iss /dLite > NUL
echo.
...
copy /y Script\NeroLite_base.iss NeroLite_main.iss > NUL
start /B /WAIT "PreProcessing - NeroLite_english_micro.iss" /low "%InnoSetupPath%\iscc.exe" NeroLite_main.iss /dMicro > NUL
echo.
del /f /q NeroLite_main.iss > NUL
popd
pause