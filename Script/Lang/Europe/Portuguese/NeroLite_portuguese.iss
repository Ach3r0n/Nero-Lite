...
#endif
#ifdef Nero7
Source: Custom\Help\NeroControlCenter_PTG.chm; DestName: NeroProductSetup_PTG.chm; DestDir: {cf}\Nero\Nero Web; Check: CheckLanguage('portuguese'); BeforeInstall: AddLanguage('PTG'); Flags: ignoreversion replacesameversion
#endif
...
#endif
#ifdef Nero7
Source: Custom\Help\NeroControlCenter_PTB.chm; DestName: NeroProductSetup_PTB.chm; DestDir: {cf}\Nero\Nero Web; Check: CheckLanguage('portuguese_brazilian'); BeforeInstall: AddLanguage('PTB'); Flags: ignoreversion replacesameversion
#endif
